...
MAX_LEN = 96
OUT_DIR = "./models/rubert-fakenews"
...
def main():
    ...
    args = TrainingArguments(
        ...
        num_train_epochs=4,
        weight_decay=0.01,
        eval_strategy="epoch",   # для твоей версии transformers
        save_strategy="epoch",
        load_best_model_at_end=True,
        metric_for_best_model="f1",
        fp16=True,               # если CUDA доступна; если упадёт — поставь False
        logging_steps=50,
        report_to="none",
    )
    ...
    trainer = Trainer(
        ...
        eval_dataset=val_ds,
        tokenizer=tokenizer,  # warning про deprecated можно игнорировать
